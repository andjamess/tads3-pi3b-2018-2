...
<section>   
    ...
    <br><br><br><br><br><br>
            ...
            <table style="background-color: #FFFFFF" name="consultaCliente" class="table table-bordered  table-dark table-hover " id="tabela"   >
                ...
                <thead style="background-color: #FFFFFF">
                    ...
                    <tr>
                        ...
                        <th  style="color:#000000;" scope="col">TELEFONE</th>
                    </tr>
                </thead>
                ...
                <tbody style="background-color: #FFFFFF">
                    ...
                    <c:forEach items="${cliente}" var="m">
                        ...
                        <tr>
                            ...
                            <td style="color:#000000;"><c:out value="${m.telefone}"/></td>
            ...
            <a href="PesquisarCliente.html" method="post">    <button method="post" class="btn btn-primary btn-lg col-md-3" type="button"  >Update</button><br></a> 
                        ...
                        function selecionaLinhaParaInput() {
                            ...
                            for (var i = 1; 0 < table.rows.length; i++)
                            {
                                ...
                                table.rows[i].onclick = function ()
                                {
                                    ...
                                    document.getElementByName("telefone").value = this.cells[4].innerHTML;
