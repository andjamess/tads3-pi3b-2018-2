...
<section>   
 ...
 <form method="post" action="ServeletUpdateFuncionario" name="formuser1" id="formuser1">

 <table name="alteraFuncionario" class="table table-bordered  table-dark table-hover " id="alteraFuncionario"   >
                ...
                <tbody>
                    ...
                    <c:forEach items="${funcionario}" var="m">
                        ...
                        <tr>
                            ...
                            <td  style="color:#ff9900;"> <input type="text" name="id" id="id" value="<c:out  value='${m.id}'/>"</td>

                            <td style="color:#ff9900;"> <input type="text" name="nome" id="nome" value="<c:out value='${m.nome}'/>"</td>
                            ...
                            <td style="color:#ff9900;"> <input type="text" id="filial" name="filial" value="<c:out value='${m.filial}'/>"</td>

                            <td style="color:#ff9900;"> <input type="text" id="cargo" name="cargo" value="<c:out value='${m.cargo}'/>"</td>
