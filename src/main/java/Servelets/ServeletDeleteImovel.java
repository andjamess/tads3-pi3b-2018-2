 ...
 * @author Dayse
 */
@WebServlet(name = "ServeletDeleteImovel", urlPatterns = {"/Deletar"})
public class ServeletDeleteImovel extends HttpServlet {
...
//         
   String id = request.getParameter("id");
      ...
      request.setAttribute("imovel",resultado);
        request.getRequestDispatcher("/WEB-INF/jsp/deleteImoveis.jsp")
